  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/banner_2.jpg" alt="Los Angeles" style="width:100%;">
      ...
      <div class="item">
        <img src="img/banner_01.jpg" alt="New York" style="width:100%;">
        
      </div>

      <!-- <div class="item">
        <img src="img/banner_03.jpg" alt="New York" style="width:100%;">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=78"><div class="shop">
							<div class="shop-img">
								<img src="./img/set-do-nu-dep-cho-gioi-tre-voi-ao-phong-quan-short-jeans.jpg" alt="">
							</div>
							<div class="shop-body">
								<h3>Clothes For Women<br>Collection</h3>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							<div class="shop-img">
								<img src="./img/SetDoNam.jpg" alt="">
							</div>
							<div class="shop-body">
								<h3>Clothes For Men<br>Collection</h3>
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=79"><div class="shop">
							<div class="shop-img">
								<img src="./img/FashionAccessories.jpg" alt="">
							</div>
							<div class="shop-body">
								<h3>Fashion Accessories<br>Collection</h3>
